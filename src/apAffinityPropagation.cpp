...
#include "apAffinityPropagation.h"

apAffinityPropagation::apAffinityPropagation() {
...
apAffinityPropagation::buildClusters(std::string filename0,std::string filename1,std::string filename2, int maxits, int convits, double lam) {
