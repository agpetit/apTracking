                 ...
                 int nrhs, const mxArray *prhs[])
{
    ...
    //initialize capturing a video from a file. cvCaptureFromFile allocates and initializes the CvCapture structure for 
    //reading the video stream from the specified file.
    //CvCapture: video capturing structure. It doesn't have a public interface and is used only as a parameter for 
	...
	CvCapture *input_video = cvCaptureFromFile(
		...
		"C:\\Users\\roman10\\Desktop\\cs5342-project\\6-code-in-matlab\\MovieData\\test1.avi"
		);
	if (input_video == NULL)
	{
    ...
    //CV_CAP_PROP_POS_AVI_RATIO: 0 indicates start of the video, 1 indicates the end of the film
	...
	while(true)
	{
        ...
        else if (key_pressed == 'e' || key_pressed == 'E') break;
		else											current_frame++;
