...
{ 
	  ...
	  //opath5 = env_ipath1 + vpIoTools::path("/imagesSoyuz/Hierarchy3/I%04d.pgm");

	  //opath5 = env_ipath1 + vpIoTools::path("/imagesAmazonas/Hierarchy/I%04d.pgm");

	  opath5 = env_ipath1 + vpIoTools::path("/imagesA380/hierarchy1/I%04d.pgm");
	  ...
	  //ogre.setRotation("Satel", vpRotationMatrix(vpRxyzVector(M_PI,0,0)));

	  ogre.setRotation("A380", vpRotationMatrix(vpRxyzVector(M_PI/3.5,0,-M_PI/10)));
...
//Satelso
//ogre.updateClipDistances0(tr[2],0.30);
...
Views.init(8,8,8,1);
Views.initSph(1,21,21);
//Views.initSph(1,3,3);
vpImage<vpRGBa> imArg(480,640);
vpImage<unsigned char> Itempl(480,640);
//vpImageIo::readPPM(Itempl, "I0221.pgm");
vpImageIo::readPPM(Itempl, "I0439.pgm");
vpImagePoint ip1;
...
ip1.set_i(i);
ip1.set_j(j+100);
vpDisplay::displayCross(Id,ip1,2,vpColor::green,2);
	}
}
}
//vpDisplay::display(Id);
...
//vpImageIo::writePPM(Ioverlay, "Idetect2.pgm");
//getchar();

//Views.edgeOrientMap(Ied);
//Views.createViews(ogre,posin,opath5);
//Views.createViewsDT(ogre,posin,opath5);
//Views.createViewsSph(ogre,posin,opath5);
Views.rotateTemp(Itempl,0);
vpImageIo::writePPM(Itempl, "Irot0.pgm");
getchar();
cout << posin << endl;
//getchar();
//Views.buildHierarchy(13.8, "hierarchy.txt");
//Views.buildHierarchy(13.8, "hierarchy.txt");
//Views.buildHierarchy1(15.5, "hierarchy1.txt");

//Satel
//Views.buildHierarchy1(7.5, "hierarchyA380.txt");

//A380
//Views.buildHierarchy1(9, "hierarchyA380.txt");

//Views.buildHierarchyMS(8, "hierarchy2.txt");
//Views.dTTemplates0();
//getchar();
t0= vpTime::measureTimeMs();
//Views.detect1(Id,opath5);
//Views.detectMS(Id,opath5);
Views.detect2(Id,opath5);
	...
	try
	{
		...
		//while(im<360){
           ...
           /* if (im==5){
            ...
            //vpImageIo::writePPM(Itex, "imtext.pgm");
